...
public class SALE_WINDOW extends javax.swing.JFrame {
    ...
    // function to populate the jtable with Sales data
    public void fillJtableWithSales()
    {
         P_SALE sales = new P_SALE();
        ArrayList<P_SALE> salesList = sales.salesList();
   ...
   }catch(Exception ex)
   {
    ...
    private void jTable_SalesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_SalesMouseClicked
        ...
        jTextField_Property_Id.setText (jTable_Sales.getValueAt (selectedRowIndex, 1).toString());
         jTextField_Client_Id.setText (jTable_Sales.getValueAt (selectedRowIndex, 2).toString());
        jTextField_Final_Price.setText (jTable_Sales.getValueAt (selectedRowIndex, 3).toString());
         jTextField_Date.setText (jTable_Sales.getValueAt (selectedRowIndex, 4).toString());
   ...
   try{
        ...
        {
          JOptionPane.showMessageDialog(null, "Sale has been Updated", "Edit Sale", 1);
            fillJtableWithSales();
        }
        else{
             JOptionPane.showMessageDialog(null, "Sale has not been Updated", "Edit Sale", 2);
        }
   }catch(Exception ex)
   {
         JOptionPane.showMessageDialog(null, "Select the Sale details", "Edit Sale", 2);
   }
   ...
   try{
        ...
        {
          JOptionPane.showMessageDialog(null, "Sale has been deleted", "Remove Sale", 1);
            fillJtableWithSales();
             jTextField_Id.setText ("");
             jTextField_Property_Id.setText ("");
             jTextField_Client_Id.setText("");
             jTextField_Final_Price.setText("");
             jTextField_Date.setText("");
            
        }
        else{
             JOptionPane.showMessageDialog(null, "Sale has not been deleted", "Remove Sale", 2);
        }
   }catch(Exception ex)
   {
         JOptionPane.showMessageDialog(null, "Enter the Sale Id", "Remove Sale", 2);
   }
